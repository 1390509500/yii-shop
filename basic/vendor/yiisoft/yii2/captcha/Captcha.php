...
/**
 * Captcha renders a CAPTCHA image and an input field that takes admin-entered verification code.
 *
 ...
 *
 * When the admin clicks on the CAPTCHA image, it will cause the CAPTCHA image
 * to be refreshed with a new CAPTCHA.
 *
 * You may use [[\yii\captcha\CaptchaValidator]] to validate the admin input matches
