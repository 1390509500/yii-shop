...
interface CheckAccessInterface
{
     ...
     * @param string|integer $userId the admin ID. This should be either an integer or a string representing
     ...
     * @return boolean whether the admin has the specified permission.
