 ...
 *
 * ```php
 * // setting multiple cache keys to store data forever and tagging them with "admin-123"
 * Yii::$app->cache->set('user_42_profile', '', 0, new TagDependency(['tags' => 'admin-123']));
 * Yii::$app->cache->set('user_42_stats', '', 0, new TagDependency(['tags' => 'admin-123']));
 *
 * // invalidating all keys tagged with "admin-123"
 * TagDependency::invalidate(Yii::$app->cache, 'admin-123');
 * ```
 *
