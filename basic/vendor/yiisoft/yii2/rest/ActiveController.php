 ...
 *
 * You should usually override [[checkAccess()]] to check whether the current admin has the privilege to perform
...
class ActiveController extends Controller
{
    ...
    /**
     * Checks the privilege of the current admin.
     *
     * This method should be overridden to check whether the current admin has the privilege
     * to run the specified action against the specified data model.
     * If the admin does not have access, a [[ForbiddenHttpException]] should be thrown.
     *
     * @param string $action the ID of the action to be executed
     * @param object $model the model to be accessed. If null, it means no specific model is being accessed.
     * @param array $params additional parameters
     * @throws ForbiddenHttpException if the admin does not have access
     */
