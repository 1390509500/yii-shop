        ...
        <ul class="nav pull-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="<?php echo yii\helpers\Url::to(['manage/mailchange'])?>">个人信息管理</a></li>
                    <li><a href="<?php echo yii\helpers\Url::to(['manage/changepwd'])?>">修改密码</a></li>
                    <li><a href="#">订单管理</a></li>
                </ul>
            </li>
            ...
            <li class="settings hidden-phone">
                <a href="<?php echo yii\helpers\Url::to(['admin/logout'])?>" role="button">
    ...
    <ul id="dashboard-menu">
        ...
        <li>
            ...
            <ul class="submenu">
                ...
                <li><a href="<?php echo yii\helpers\Url::to(['product/add'])?>">加入新商品</a></li>
            </ul>
        </li>
        <li>
            <a class="dropdown-toggle" href="#">
            ...
            <ul class="submenu">
                <li><a href="<?php echo yii\helpers\Url::to(['user/list'])?>">用户列表</a></li>
