                ...
                <table class="table table-hover">
                    ...
                    <?php foreach($users as $user): ?>
                        <tr class="first">
                            ...
                            <td>
                                <?php echo isset($user->profile->year) ? $user->profile->year : '未填写'; ?>
                            </td>
                            <td>
                                <?php echo isset($user->profile->city) ? $user->profile->province."省".$user->profile->city : '未填写'; ?>
                            </td>
