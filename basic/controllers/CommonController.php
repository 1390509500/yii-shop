...
class CommonController extends Controller
{
    public function init()
    {
        ...
        $tui = Product::find()->where('istui = "1" and ison = "0"')->orderby('createtime desc')->limit(3)->all();
        $new = Product::find()->where('ison = "0"')->orderby('createtime desc')->limit(3)->all();
        $hot = Product::find()->where('ison = "0" and ishot = "1"')->orderby('createtime desc')->limit(3)->all();
        $sale = Product::find()->where('ison = "0" and issale = "1"')->orderby('createtime desc')->limit(3)->all();
