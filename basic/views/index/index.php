        ...
        <div class="col-xs-12 col-sm-8 col-md-9 homebanner-holder">
            ...
            <div id="hero">
                <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                    ...
                    <div class="item" style="background-image: url(front/images/sliders/slider01.jpg);">
                    ...
                    <!--<div class="item" style="background-image: url(front/images/sliders/slider02.jpg);">
                        <div class="container-fluid">
                            <div class="caption vertical-center text-left">
                                <div class="big-text fadeInDown-1">
    ...
    <div class="container">
        <div class="col-xs-12 col-lg-6 no-margin banner">
            <a href="category-grid.html">
                ...
                <img class="banner-image" alt="" src="front/images/blank.gif" data-echo="front/images/banners/banner-narrow-01.jpg" />
            </a>
        </div>
        <div class="col-xs-12 col-lg-6 no-margin text-right banner">
            <a href="category-grid.html">
                ...
                <img class="banner-image" alt="" src="front/images/blank.gif" data-echo="front/images/banners/banner-narrow-02.jpg" />
            </a>
        </div>
    </div><!-- /.container -->
                ...
                <div class="row no-margin">
                    <?php for ($i = 0;$i < 3;$i++): ?>
                        ...
                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                            <div class="product-item">
                                <div class="image">
                                    <img alt="<?php echo $data['all'][$i]->title ?>" src="<?php echo $data['all'][$i]->cover ?>" data-echo="<?php echo $data['all'][$i]->cover ?>" />
                                </div>
                                <div class="body">
            ...
            <div class="col-xs-12 col-md-5 no-margin">
                <div class="product-item-holder size-big single-product-gallery small-gallery">
                        ...
                        <?php foreach((array)json_decode($last->pics, true) as $key => $pic): ?>
                            <div class="single-product-gallery-item" id="slide<?php echo $key+2; ?>">
                                <a data-rel="prettyphoto" href="<?php echo $last->pics ?>">
                                    <img alt="" src="<?php echo $pic['pic_big'] ?>" data-echo="<?php echo $pic['pic_big'] ?>" />
                                </a>
                            </div><!-- /.single-product-gallery-item -->
                        <?php endforeach; ?>
                    ...
                    <div class="gallery-thumbs clearfix">
                        <ul>
                            <li><a class="horizontal-thumb active" data-target="#best-seller-single-product-slider" data-slide="0" href="#slide1"><img alt="<?php echo $last->title ?>" src="<?php echo $last->cover ?>" width="67" height="60" data-echo="<?php echo $last->cover ?>" /></a></li>
                            <?php foreach ((array)json_decode($last->pics, true) as $key => $pic): ?>
                                <li><a class="horizontal-thumb" data-target="#best-seller-single-product-slider" data-slide="<?php echo $key; ?>" href="#slide<?php echo $key+1; ?>"><img alt="" src="<?php echo $pic['pic_min'] ?>" data-echo="<?php echo $pic['pic_min'] ?>" /></a></li>
                            <?php endforeach; ?>
                        </ul>
                    </div><!-- /.gallery-thumbs -->
